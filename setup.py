...
setup(name='enigma2-plugin-extensions-opdboot',
		...
		package_data={'Extensions.OPDBoot': ['*.mvi', '*.png', 'images/*.png', 'ubi_reader/*', 'ubi_reader/ubi/*', 'ubi_reader/ubifs/*', 'ubi_reader/ubi_io/*', 'ubi_reader/ui/*', 'bin/*', 'OPDBoot_client/*', 'OPDBoot_client/images/*.png']},
